...
{
    public static Models.SCREEN_MODE_ENUM CURRENT_SCREEN = Models.SCREEN_MODE_ENUM.HOME;
    public static Models.SCREEN_MODE_ENUM LAST_SCREEN = Models.SCREEN_MODE_ENUM.HOME;
